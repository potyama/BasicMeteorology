...
\item
  ...
  \item
    ...
    シュワルター安定指数\\$(T_{500}-T_p)$ \\エマグラム上で850hPa面にある空気の気温と露天から出発し、500hPa面まで強制的に持ち上げたときの気塊の温度を引く\\
    リフティド指数\\$(T_{500} - T_p)$\\シュワルター安定指数とほどんど同じだが、気塊は海面気圧とほぼ同じ1000hPaである。

  \item
  相当温位はマイナスになり、対流雲を生じやすく、強い降水や雷を伴うことが多い。
